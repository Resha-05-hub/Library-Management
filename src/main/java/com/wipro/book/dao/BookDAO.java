...
public class BookDAO {
	...
	public int createBook(BookBean bookbean) {
		...
		String insertBook = "INSERT INTO BOOK_TABLE VALUES(?,?,?,?,?)";

		String checkAuthor = "SELECT AUTHOR_NAME FROM AUTHOR_TABLE WHERE AUTHOR_CODE = ?";

		String insertAuthor = "INSERT INTO AUTHOR_TABLE(AUTHOR_CODE, AUTHOR_NAME,CONTACT_NO) VALUES (?,?,?)";
